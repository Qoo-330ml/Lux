...
- [x] 当前源码构建带版本和 revision label 的 ARM64 镜像 `lux:0.1.0-arm64-local`；`org.opencontainers.image.version=0.1.0`、revision=70474bc，非 root uid=10001、ffprobe、`/health/live`、`/health/ready` 和管理员健康写能力均已验证。
