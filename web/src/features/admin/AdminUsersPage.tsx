...
import { Ban, Check, KeyRound, Plus, ShieldCheck, Trash2, UserRound, X } from "lucide-react";
...
function UserAdminRow({ user, libraryIds, libraryNames }: { user: AdminUser; libraryIds: string[]; libraryNames: Map<string, string> }) {
  ...
  const actionPending = disable.isPending || remove.isPending;
