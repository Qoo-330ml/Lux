...
function brandLogo(className, alt = "") {
  ...
  return `<img class="${className}" src="/logo.svg" alt="${escapeHtml(alt)}" width="202" height="229"${decorative} decoding="async">`;
}
...
function brand() { return "<div class=\"brand\"><button class=\"brand-home\" type=\"button\" data-route=\"home\">" + brandLogo("brand-logo") + "<span><strong>Lux</strong><small>quietly yours</small></span></button><button class=\"drawer-close\" type=\"button\" data-action=\"close-drawer\" aria-label=\"关闭导航\">×</button></div>"; }
function nav() {
