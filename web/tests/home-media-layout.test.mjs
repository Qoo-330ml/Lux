...
test("home media actions are hidden until the poster is hovered and sit in its lower-right corner", () => {
  ...
  assert.match(actionsRule, /bottom:\s*9px/);
  assert.match(actionsRule, /top:\s*auto/);
