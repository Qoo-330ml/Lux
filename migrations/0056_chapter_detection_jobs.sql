CREATE TABLE chapter_detection_jobs (
    ...
    intro_window_seconds INTEGER NOT NULL CHECK (intro_window_seconds BETWEEN 15 AND 300),
    credits_window_seconds INTEGER NOT NULL CHECK (credits_window_seconds BETWEEN 15 AND 600),
    match_threshold REAL NOT NULL CHECK (match_threshold >= 0.0 AND match_threshold <= 1.0),
    cursor TEXT,
