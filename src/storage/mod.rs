...
pub(crate) use repository::{
    ...
    StoredExternalSubtitle, StoredFilesystemEntry, StoredFolderScanPath, StoredImageIdentity,
    StoredItemImage, StoredItemImageCandidate, StoredItemImagePathConflict, StoredItemScanPath,
