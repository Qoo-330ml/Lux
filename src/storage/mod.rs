...
pub(crate) use repository::{
    ...
    StoredScanJobPath, StoredScanManifest, StoredScanManifestDirectory, StoredScheduledTaskConfig,
    StoredScheduledTaskPlan, StoredScheduledTaskPlanLibrary, StoredSeriesMetadataSource,
