...
pub(crate) use repository::{
    ...
    ItemImageMetadata, LibrarySettingsUpdate, ManifestDeltaBatchCommit,
    ManifestDeltaBatchCommitResult, ManifestExistingFileUpdate, MediaMetadataUpdate,
    ...
    NewNotificationEvent, NewPersonCredit, NewPlaybackEvent, NewScanJobEvent, NewScanManifest,
    NewScanManifestDelta, NewScanManifestDiscoveryChunk, NewScanManifestEntry, NewScanManifestRoot,
    NewScanManifestSidecarEntry, NewScanManifestUnresolvedFile, NewStrmProbeJob,
    ...
    StoredScanJobPath, StoredScanManifest, StoredScanManifestDelta,
