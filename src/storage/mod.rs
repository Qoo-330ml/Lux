...
pub(crate) use repository::{
    ...
    NewScanManifestFilesystemEntry, NewScanManifestRoot, NewScanManifestSidecarEntry,
    ...
    StoredAccessTokenDevice, StoredActivityEvent, StoredAuditEvent, StoredCanonicalPerson,
